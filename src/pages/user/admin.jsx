    ...
    return (
        <div className="flex h-screen overflow-hidden">
            <Helmet>
                ...
                <meta name="description" content="Admin dashboard for managing SaiFashionZone by Raiba's clothing store operations." />
            </Helmet>
            <div 
            ...
            <div className="flex-1 flex flex-col relative">
                <header className="lg:hidden p-4 border-b flex items-center">
                    ...
                    <h1 className="text-xl font-semibold">Admin Dashboard - SaiFashionZone</h1>
                </header>
