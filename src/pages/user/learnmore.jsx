...
const LearnMore = ({ product, onBack }) => {
  return (
    <>
      <Helmet>
            ...
            <div className="p-8 flex flex-col justify-between">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {[{ icon: FaClock, text: product.availability },
                    { icon: FaUsers, text: `${product.sold} sold` },
                    { icon: FaTag, text: `Size: ${product.size}` },
                    { icon: FaShoppingCart, text: `Stock: ${product.stock}` }
